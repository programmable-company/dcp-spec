...
A Programmable Company is a Git repository. The repository is the unit of conformance: tooling that reads, validates, or signs artifacts operates over a repository, and a repository's history is part of its identity.

This section defines the file and directory layout that makes a Git repository a conformant Programmable Company repository.
...
## What MUST NOT appear in a Programmable Company repository
