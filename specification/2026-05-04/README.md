# Programmable Company — specification draft `2026-05-04`

This directory contains the prose specification for the Programmable Company declarative layer, draft `2026-05-04`. It pairs with the schema under [`../../schema/2026-05-04/`](../../schema/2026-05-04/), which is the TypeScript and JSON Schema source of truth.
...
| [`02-repository-structure.md`](02-repository-structure.md) | What files and directories make a Programmable Company repository. |
