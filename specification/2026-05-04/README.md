# Declarative Company — specification draft `2026-05-04`

This directory contains the prose specification for **Declarative Company**, draft `2026-05-04`. Declarative Company is the data-layer specification of the Programmable Company project; it pairs with the schema under [`../../schema/2026-05-04/`](../../schema/2026-05-04/), which is the TypeScript and JSON Schema source of truth.

A future programmable-layer specification, under the same project, will define runtime / interaction behavior over Declarative Company artifacts. That layer is out of scope here.
...
| [`02-repository-structure.md`](02-repository-structure.md) | What files and directories make a Declarative Company repository. |
