...
| --- | --- | --- |
| **Programmable Company** | The specification, taken as a whole, and (by extension) a company represented under it. | This document |
...
| **Repository** | A Git repository conforming to [§02](02-repository-structure.md), holding a single Programmable Company entity. | [§02](02-repository-structure.md) |
