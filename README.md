...
For the thesis behind the protocol, see [VISION.md](VISION.md). For the constraints that will shape its design, see [PRINCIPLES.md](PRINCIPLES.md). For how the project is stewarded, see [GOVERNANCE.md](GOVERNANCE.md).
